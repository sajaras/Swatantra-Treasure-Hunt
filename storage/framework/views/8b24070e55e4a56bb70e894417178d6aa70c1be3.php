...
<html lang="en">
  <head>
    ...
    <link href="//netdna.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css" rel="stylesheet">
      ...
      <link href="<?php echo e(URL::asset('css/profile.css')); ?>" rel="stylesheet">
...
<br>
   <div class="container-fluid" id="topmostcontainer">
    ...
    <img src="/storage/profile_avatars/<?php echo e($user->profile_avatar); ?>" id="profimg">
    <br>
        <span id="proelement1">Name </span> <span id="proelement2" >:</span><span id="proelement3"><?php echo e($user->name); ?></span> 
        <br>        
        <span id="proelement4">Phone </span> <span id="proelement5" >:</span><span id="proelement6"><?php echo e($user->phoneno); ?></span> 
        <br>        
        <span id="proelement7">Email </span> <span id="proelement8" >:</span><span id="proelement9"><?php echo e($user->email); ?></span> 
        <br> 
         <span id="proelement10">College </span> <span id="proelement11">:</span><span id="proelement12"><?php echo e($user->college); ?></span> 
        <br>               
