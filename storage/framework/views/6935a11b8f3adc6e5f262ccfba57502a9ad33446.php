        ...
        <div class="container-fluid" id="test">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(route('adminhomepage')); ?>" id="glyphy"><span  class="glyphicon glyphicon-link"></span></a>
                  ...
                  <a class="navbar-brand" href="<?php echo e(route('admintechiehomepage')); ?>" id="glyphy"><span  class="glyphicon glyphicon-text-background"></span></a>
               
                  <a class="navbar-brand" href="<?php echo e(route('techiequestionlist')); ?>" id="glyphy"><span  class="glyphicon glyphicon-book"></span></a>
                <a class="navbar-brand" href="<?php echo e(route('adminaddquestiontechie')); ?>" id="glyphy"><span  class="glyphicon glyphicon-plus-sign"></span></a>
...
<p style="margin:0px;">-The Treasure Hunt has 20 Level in which each Level consist of 1 Question.</p>
<p style="margin:0px;">-The Treasure Hunt has currently <span style="font-size:18px;margin-right:2px;"><?php echo e($totalquestion); ?></span>questions.</p>
...
<p style="font-weight:bold;text-decoration:underline;margin:0px;">Prizes</p>
...
<p>-The Player who completes the <span style="font-size:18px; font-weight:bold;">20</span> th level first will be declared the winner,ie Player who comes Rank 1 in Leaderboard.</p>

<p style="font-weight:bold;text-decoration:underline;margin:0px;">Deciding Runner Up & Second Runner Up</p>
<p>-As Soon as the first is declared,All Player Except the First Prize Winner have to go through <span style="font-size:18px; font-weight:bold;">2</span> extra levels apart from the 20 Levels to compete for the second and third Prize.Top 2 players from that 22 levels will be declared the first and second Runner up Respectively.</p>

<p style="font-weight:bold;text-decoration:underline;margin:0px;">Clues & Hints</p>
<p style="margin:0px;">-Clues will be available in the SwatantraHunt Facebook page <a href="https://www.facebook.com/pg/swatantra.treasurehunt/posts/" target="_blank"> Swatantra Hunt Fb</a> and Swatantra Hunt Telegram group <a href="https://t.me/swatantra_treasurehunt" target="_blank">Swatantra Hunt Telegram</a>.</p>
...
<p style="margin:0px;" >-Anyone who attempts malpractices like hacking will be blocked at once. </p>
<p style="margin:0px;">-Only 1 account per Person.Any such malpractises could even lead to prize cancellation for the Player.</p>
