...
<html lang="">
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1">
         ...
         <?php if($currentuserdata->level <= $totalquestion): ?>
		<title>Level-<?php echo e($currentlevelquest->questno); ?></title>
        <?php else: ?>
		...
		<link href="<?php echo e(URL::asset('css/huntpage.css')); ?>" rel="stylesheet">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="topcontainer">
        ...
        <div class="container-fluid" id="test">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(route('home')); ?>" id="glyphy"><span  class="glyphicon glyphicon-road"></span></a>
                <a class="navbar-brand" href="<?php echo e(route('leaderboard')); ?>" id="glyphy"><span  class="glyphicon glyphicon-king"></span></a>
                <a class="navbar-brand" href="#" id="glyphy" data-toggle="modal" data-target="#rules_modal"><span  class="glyphicon glyphicon-registration-mark"></span></a>
                  ...
                  <a class="navbar-brand" href="<?php echo e(route('winnerspage')); ?>" id="glyphy"><span  class="glyphicon glyphicon-education"></span></a>

                 <a class="navbar-brand" href="<?php echo e(route('aboutpage')); ?>" id="glyphy"><span  class="glyphicon glyphicon-paperclip"></span></a>
            </div> 
...
<div class="cards-container">
  <?php for($i=0; $i < $noofdigusers; $i++): ?>
    <div class="card">
      <div class="eachcardfront">
        <span id="cardusr<?PHP echo $i; ?>" class="fontclasscard"><?php echo e($totalusers[$i]); ?></span>
      </div>
 ...
 <?php echo $__env->make('cardletter', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
    
  <div class="cards-container attemptscards">
  <?php for($i=0; $i < $noofdigits; $i++): ?>
    <div class="card attcard">
      <div class="eachcardfront">
        <span id="cardelement<?PHP echo $i; ?>" class="fontclasscard" ><?php echo e($totalattempts[$i]); ?></span>
      </div>
      <div class="eachcardback">
        <span></span>
      </div>
  ...
  <?php echo $__env->make('cardhunt', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
    ...
    <div  class="container" id="levelbox">
     <span id ="levelteller">LEVEL:</span><span id="levelteller"><?php echo e($currentlevelquest->questno); ?></span>
     <?php else: ?>
  ...
  <div class="container" id="answerbox">
    <form action="<?php echo e(route('anscheck')); ?>" method="POST">
    ...
    <div  class="container" id="questionboxcompleted">
     ...
     <div><p><b>Oh Great...if you are  a Student User, Winning Questions are uploaded as follows 1st prize question:26th Nov 2pm.2nd Prize Question: 27th Nov 2pm .Third prize Question:28th Nov 2pm. If you are a Techie/Other User Please Wait till admin upload new questions.<b></b></div>
...
for (i = 0; i < dtlength; i++) { 
     ...
     $("#cardelement"+i).load(location.href + ' #cardelement'+i);
      ...
      $.ajax({
    url:"<?php echo e(route('takeusercount')); ?>",
    type: 'post',
    data: {_method:'get','_token':$('input[name=_token]').val()},
    success: function(data){ 
