    ...
    <br>         
        ...
        <table class="table table-fixed table-hover" >
          <thead>
           ...
           <tbody>
          <?php if(count($questdata)): ?>
           <?php $__currentLoopData = $questdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eachquestion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <tr class="currentrowcontact" id="rowelement" data-toggle="" data-target=""> 
       <td class="col-xs-1 col-sm-1 col-md-1 col-lg-1" id="questno"><?php echo e($eachquestion->questno); ?></td><td class=" col-xs-8 col-sm-8 col-md-8 col-lg-8" id="quests"><?php echo e($eachquestion->quest); ?></td><td class="col-xs-2 col-sm-2 col-md-2 col-lg-2" id="answers">***********</td><td class="col-xs-1 col-sm-1 col-md-1 col-lg-1" id="deletebutton"><button class="btn btn-danger" id ="deletebutton" value ="<?php echo e($eachquestion->questno); ?>">Delete </button></td> 
...
{
$.ajax({
    url:"<?php echo e(route('questiondeletetechie')); ?>",
    type: 'post',
