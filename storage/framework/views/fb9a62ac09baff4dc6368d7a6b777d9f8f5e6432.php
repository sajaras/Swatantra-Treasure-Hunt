    ...
    <br>         
        ...
        <table class="table table-fixed table-hover" >
          <thead>
           ...
           <tbody>
          <?php if(count($mycurrentlists)): ?>
           <?php $__currentLoopData = $mycurrentlists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eachuser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <tr class="currentrowcontact" id="rowelement" data-toggle="modal" data-target="#PreviewModal"> 
          <td class="text-center col-xs-1 col-sm-1 col-md-1 col-lg-1"><span><img src="/storage/profile_avatars/<?php echo e($eachuser->profile_avatar); ?>" style="width:20px;height:20px;border-radius:50%;"></span></td><td class="text-center col-xs-2 col-sm-2 col-md-2 col-lg-2" id="currentposition"><?php echo e($loop->iteration); ?></td><td class="text-center col-xs-3 col-sm-3 col-md-3 col-lg-3" id="currentname"><?php echo($eachusrclg = (strlen($eachuser->name) > 15) ? substr($eachuser->name,0, 13).'..' : $eachuser->name); ?></td><td class="text-center col-xs-2 col-sm-2 col-md-2 col-lg-2" id="college"> <?php echo($eachusrclg = (strlen($eachuser->college) > 10) ? substr($eachuser->college,0,8).'...' : $eachuser->college); ?> </td><td class="text-center col-xs-1 col-sm-1 col-md-1 col-lg-1" id="currentlevel"><?php echo e($eachuser->level); ?></td><td class="text-center col-xs-3 col-sm-3 col-md-3 col-lg-3" id= "formobilehead"><?php echo e($eachuser->prevlevcompleted_at); ?></td> 
          ...
          <input type="hidden" id="photo" value="<?php echo e($eachuser->profile_avatar); ?>">
             <input type="hidden" id="currentfullname" value= "<?php echo e($eachuser->name); ?>">
            <input type="hidden" id="currentfullcollegename" value= "<?php echo e($eachuser->college); ?>">
            <?php if(Auth::user()->id == $eachuser->user_id): ?>
            <input type="hidden" id="myrank" value="<?php echo e($loop->iteration); ?>">
            <?php endif; ?>
          </tr>
