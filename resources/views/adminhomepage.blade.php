    ...
    <br>         
        ...
        <table class="table table-fixed table-hover" >
         ...
         <tr class="currentrowcontact" id="rowelement" data-toggle="modal" data-target="#PreviewModal"> 
          <td class="text-center col-xs-1 col-sm-1 col-md-1 col-lg-1"><span><img src="/storage/profile_avatars/{{ $eachuser->profile_avatar }}" id="admpageimage"></span></td><td class="text-center col-xs-2 col-sm-2 col-md-2 col-lg-2" id="currentposition">{{$loop->iteration}}</td><td class="text-center col-xs-2 col-sm-2 col-md-2 col-lg-2" id="currentname"><?php echo($eachusrclg = (strlen($eachuser->name) > 15) ? substr($eachuser->name,0, 13).'..' : $eachuser->name); ?></td><td class="text-center col-xs-2 col-sm-2 col-md-2 col-lg-2" id="college">{{$eachuser->phoneno}}</td><td class="text-center col-xs-1 col-sm-1 col-md-1 col-lg-1" id="currentlevel">{{$eachuser->level}}</td><td class="text-center col-xs-2 col-sm-2 col-md-2 col-lg-2" id= "formobilehead1"><?php echo($eachusrclg = (strlen($eachuser->email) > 18) ? substr($eachuser->email,0, 15).'..' : $eachuser->email); ?></td><td class="text-center col-xs-2 col-sm-2 col-md-2 col-lg-2" id= "formobilehead1">{{$eachuser->attempts}}</td>  
